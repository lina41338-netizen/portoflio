...
const socialLinks = [
  ...
  {
    platform: 'Instagram',
    href: 'https://www.instagram.com/rehan_hannz45?igsh=YzljYTk1ODg3Zg==',
    iconPath: '/icons/instagram_icon.svg',
  },
  {
    platform: 'Gmail',
    href: 'muhammad.rehan5564@smk.belajar.id',
    iconPath: '/icons/gmail_icon.svg',
  },
  {
    platform: 'WhatsApp',
    href: 'https://wa.me/6283119691902',
    iconPath: '/icons/whatsapp_icon.svg',
  },
];

// Define contact information
const contactInfo = {
  email: 'lina41338@gmail.com',
};
...
export default function Contact() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const message = formData.get('pesan')?.toString() || '';
